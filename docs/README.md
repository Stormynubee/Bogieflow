# Bogie Flow Documentation Index

Welcome to the detailed documentation for Bogie Flow. This folder contains reference specifications, guides, and plans detailing the hardware integration, algorithmic foundations, and user experiences.
...
* **[Physics Formulas (physics.md)](physics.md)**: Mathematical equations for hydrology decay, vibration response, and risk coefficients.
* **[WebSocket Schema (ws-schema.md)](ws-schema.md)**: Real-time API schema, broadcast types, and JSON payload structures.
